...
# source is near- but not perfectly symmetric (and one pair was unlisted); both are
# handled by symmetrising e(a,b) = (e[a][b] + e[b][a]) / 2 in structural_grid().
MJ_AA = list("ACDEFGHIKLMNPQRSTVWY")
MJ_CONTACT = {
    "A": [-0.12, -0.33, 0.27, 0.38, -0.36, -0.08, 0.07, -0.37, 0.41, -0.38, -0.27, 0.00, 0.15, 0.22, 0.24, 0.10, 0.04, -0.32, -0.27, -0.20],
    ...
    "N": [0.00, -0.01, 0.02, 0.12, -0.01, -0.01, 0.00, 0.14, 0.22, 0.04, 0.04, -0.06, 0.18, 0.06, 0.10, 0.09, 0.04, 0.12, -0.10, -0.11],
