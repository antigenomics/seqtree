...
\author{Mikhail Shugay$^{1,2,3}$\\[3pt]
\small $^{1}$Institute of Translational Medicine, Russian National Medical State University, Moscow, Russia\\
\small $^{2}$Department of Genomics of Adaptive Immunity, Shemyakin--Ovchinnikov Institute of Bioorganic Chemistry RAS, Moscow, Russia\\
\small $^{3}$Institute of Molecular Biology NAS RA, Erevan, Armenia\\[3pt]
\small \textit{seqtree technical appendix}\quad\textbullet\quad\href{mailto:mikhail.shugay@gmail.com}{mikhail.shugay@gmail.com}}
\date{}
